...
gchar *categories_de_base_debit [] = {
    ...
    N_("Children : Studies"),
    N_("Studies : Lessons"),
    N_("Studies : School fees"),
    N_("Studies : Books"),
    N_("Miscellaneous : Gifts"),
    N_("Financial expenses : Miscellaneous"),
    ...
    N_("Professional expenses : Non refundable"),
    N_("Professional expenses : Refundable"),
    N_("Taxes : Miscellaneous"),
    N_("Taxes : Income"),
    N_("Taxes : Land"),
    N_("Housing : Hotel"),
    N_("Housing : Rent"),
