...
/* appelée lorsque la catÃ©gorie est Ventilation lors de l'enregistrement d'une opé */
						      ...
						      gpointer null )
{
    ...
    /*   si la largeur de grisbi est < 639, on fait rien */

    if ( window -> allocation.width < 639 )
	return;
