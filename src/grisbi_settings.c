...
static void grisbi_settings_init_settings_form (GSettings *settings)
{
	...
	conf.combo_categ_ib_use_gtk_completion = g_settings_get_boolean (settings, "combofix-categ-ib-use-gtk-completion");
	conf.combo_payee_use_gtk_completion = g_settings_get_boolean (settings, "combofix-payee-use-gtk-completion");
