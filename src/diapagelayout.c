...
#include "xpm/portrait.xpm"
#include "xpm/landscape.xpm"
...
dia_page_layout_init(DiaPageLayout *self)
{
  ...
  /* paper size */
  frame = gtk_frame_new("Paper Size");
...
/*   self->scale = gtk_radio_button_new_with_label(NULL, "Scale:"); */
...
/* 			GTK_RADIO_BUTTON(self->scale)->group, "Fit to:"); */
...
/*   gtk_window_set_title(GTK_WINDOW(win), "Page Setup"); */
