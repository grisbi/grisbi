...
static GtkWidget *archive_export_treeview;
static GtkWidget *archive_export_label;
static GtkWidget *archive_export_filechooser;
static GtkWidget *archive_export_combobox;
static GtkWidget *archive_export_label_success;
