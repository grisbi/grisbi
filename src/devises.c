...
static struct iso_4217_currency iso_4217_currencies[] = {
    ...
    { N_("Europe"), N_("Euro"), N_("CEE"), "EUR", "‚Ç¨", TRUE },
...
gint ligne_selection_devise;               /* contient la ligne sÈlectionnÈe dans la liste des devises */
...
/* retourne le menu d'un option menu avec les diffÈrentes devises dÈfinies */
...
/* liste_tmp est la liste utilisÈe : soit liste_struct_devises dans le cas gÈnÈral, */
/*                       soit liste_struct_devises dans le cas des paramËtres */
/* **************************************************************************************************** */
...
{ 
    ...
    /*     mis sur collapse, trouve Áa plus pratique ‡ discuter si nÈcessaire [cedric] */
...
/* appelÈe pour crÈer une nouvelle devise */
/* soit c'est la clist des paramËtres */
/* soit il est NULL, quand il provient de l'import ou nouveau fichier */
/* dans tous les cas, on ne repart pas s'il n'y a aucune devise dÈfinie */
/***********************************************************************************************************/
...
reprise_dialog:
	...
	case 1 :
	    ...
	    {
		/* 		recherche si la devise existe dÈj‡, si c'est le cas, on refuse */
				  ...
				  GtkWidget *frame )
{
    ...
    /*     nÈcessaire d'interdire le changement du nom de l'euro car tous les tests se font sur son nom */
...
/* **************************************************************************************************************************** */
/* cette fonction prend en argument un montant, la devise de renvoi (en gÈnÈral la devise du compte) */
/*      et la devise du montant donnÈ en argument */
/* elle renvoie le montant de l'opÈration dans la devise de renvoi */
/* **************************************************************************************************************************** */
...
/* ***************************************************************************************** */
/* renvoie le nom de la devise donnÈ en argument */
/* ***************************************************************************************** */
