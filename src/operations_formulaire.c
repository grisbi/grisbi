...
/******************************************************************************/
void incremente_decremente_date ( GtkWidget *entree, gint demande )
{
  gchar **tableau_char;
  GDate *date;
  ...
  jour = my_strtod ( tableau_char[0], NULL );
  mois = my_strtod ( tableau_char[1], NULL );
  annee = my_strtod ( tableau_char[2], NULL );
