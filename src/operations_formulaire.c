...
gboolean modifie_date ( GtkWidget *entree )
{
  ...
  if ( !strlen ( pointeur_entry ) )
  ...
  else
    {
      ...
      tab_date = g_strsplit ( pointeur_entry,
			      "/",
			      3 );
      ...
      if ( tab_date[2] && tab_date[1] )
	{
	  ...
	  jour = strtod ( tab_date[0],
			  NULL );
	  mois = strtod ( tab_date[1],
			  NULL );
	  annee = strtod ( tab_date[2],
			   NULL );
