			       ...
			       gint ligne )
{
  ...
  if ( etat_courant -> utilise_categ
	   ...
	   !changement_de_groupe_etat )
	{
	  ...
	  ligne = gnomeprint_affichage . affiche_totaux_sous_jaccent ( 2,
	ligne );
			    ...
			    gint ligne )
{
  ...
  if ( etat_courant -> utilise_ib
	   ...
	   !changement_de_groupe_etat )
	{
	  ...
	  ligne = gnomeprint_affichage . affiche_totaux_sous_jaccent ( 4,
	ligne );
			   ...
			   gint ligne )
{
  ...
  if ( etat_courant -> regroupe_ope_par_compte
	   ...
	   !changement_de_groupe_etat )
	{
	  ...
	  ligne = gnomeprint_affichage . affiche_totaux_sous_jaccent ( 5,
	ligne );
