...
static struct iso_4217_currency iso_4217_currencies[] = {
  { "ET", "Afrique", "birr", "Ethiopie", "ETB" },
  { "GH", "Afrique", "cedi", "Ghana", "GHC" },
  { "GM", "Afrique", "dalasie", "Gambie", "GMD" },
  { "DZ", "Afrique", "dinar algérien", "Algérie", "DZD" },
  { "LY", "Afrique", "dinar Iybien", "Lybie", "LYD" },
  { "TN", "Afrique", "dinar tunisien", "Tunisie", "TND" },
  { "MA", "Afrique", "dirham marocain", "Maroc", "MAD" },
  { "ST", "Afrique", "dobra", "Sâo Tomé - Principe", "STD" },
  { "LR", "Afrique", "dollar libérien", "Libéria", "LRD" },
  { "GQ", "Afrique", "ekwele", "Guinée Equatoriale", "GQE" },
  { "NE", "Afrique", "franc CFA (BCEAO)", "Niger", "XOF" },
  { "SN", "Afrique", "franc CFA (BCEAO)", "Senegal", "XOF" },
  { "CM", "Afrique", "franc CFA (BEAC)", "Cameroun", "XAF" },
  { "CG", "Afrique", "franc CFA (BEAC)", "Congo", "XAF" },
  { "TD", "Afrique", "franc CFA (BEAC)", "Tchad", "XAF" },
  { "DJ", "Afrique", "franc de Djibouti", "Djibouti", "DIF" },
  { "KM", "Afrique", "franc des Comores", "Comores", "KMF" },
  { "BI", "Afrique", "franc du Burundi", "Burundi", "BIF" },
  { "RW", "Afrique", "franc du Rwanda", "Rwanda", "RWF" },
  { "MG", "Afrique", "franc malgache", "Madagascar", "MGF" },
  { "ML", "Afrique", "franc malien", "Mali", "MLF" },
  { "MW", "Afrique", "kwacha", "Malawi", "MWK" },
  { "ZM", "Afrique", "kwacha", "Zambie", "ZMK" },
  { "AO", "Afrique", "kwanza", "Angola", "AOK" },
  { "SL", "Afrique", "leone", "Sierra Leone", "SLL" },
  { "SZ", "Afrique", "lilangeni", "Swaziland", "SZL" },
  { "EG", "Afrique", "livre égyptienne", "Egypte", "EGP" },
  { "SD", "Afrique", "livre soudanaise", "Soudan", "SDP" },
  { "MZ", "Afrique", "metical", "Mozambique", "MZM" },
  { "NG", "Afrique", "naira", "Nigeria", "NGN" },
  { "MR", "Afrique", "ouguija", "Mauritanie", "MRO" },
  { "GW", "Afrique", "peso de Guinée-Bissau", "Guinée-Bissau", "GWP" },
  { "BW", "Afrique", "pula", "Botswana", "BWP" },
  { "ZA", "Afrique", "rand", "Afrique du Sud", "ZAR" },
  { "LS", "Afrique", "rand", "Lesotho", "ZAR" },
  { "NA", "Afrique", "rand", "Namibie", "ZAR" },
  { "SC", "Afrique", "roupie des Seychelles", "Seychelles", "SCR" },
  { "SO", "Afrique", "shilling de Somalie", "Somalie", "SOS" },
  { "TZ", "Afrique", "shilling de Tanzanie", "Tanzanie", "TZS" },
  { "KE", "Afrique", "shilling du Kenya", "Kenya", "KES" },
  { "UG", "Afrique", "shilling ougandais", "Ouganda", "UGS" },
  { "GN", "Afrique", "syli", "Guinée", "GNS" },
  { "ZW", "Afrique", "Zimbabwe dollar", "Zimbabwe", "ZWD" },
  { "PA", "Amérique centrale", "balboa", "Panama", "PAB" },
  { "CR", "Amérique centrale", "colon", "Costa Rica", "CRC" },
  { "NI", "Amérique centrale", "cordoba", "Nicaragua", "NIC" },
  { "BZ", "Amérique centrale", "dollar de Belize", "Belize", "BZD" },
  { "PA", "Amérique centrale", "dollar des Etats-Unis", "Océanie américaine", "USD" },
  { "HN", "Amérique centrale", "lempira", "Honduras", "HNL" },
  { "GT", "Amérique centrale", "quetzal", "Guatemala", "GTQ" },
  { "CA", "Amérique du Nord", "dollar canadien", "Canada", "CAD" },
  { "BB", "Amérique du Nord", "dollar de Barbade", "Barbade", "BBD" },
  { "TT", "Amérique du Nord", "dollar de la Trinité", "Trinité-et-Tobago", "TTD" },
  { "BS", "Amérique du Nord", "dollar des Bahamas", "Bahamas", "BSD" },
  { "BM", "Amérique du Nord", "dollar des Bermudes", "Berrnudes", "BMD" },
  { "KY", "Amérique du Nord", "dollar des Caimanes", "Iles Caimanes", "KYD" },
  { "GD", "Amérique du Nord", "dollar des Caraïbes", "Grenade", "XCD" },
  { "LC", "Amérique du Nord", "dollar des Caraïbes", "St. Lucia", "XCD" },
  { "US", "Amérique du Nord", "dollar des Etats-Unis", "Etats-Unis", "USD" },
  { "JM", "Amérique du Nord", "dollar jamaicain", "Jamaique", "JMD" },
  { "AN", "Amérique du Nord", "florin des Antilles néerl.", "Curaçao e.a.", "ANG" },
  { "GP", "Amérique du Nord", "franc français", "Guadeloupe", "FRF" },
  { "MQ", "Amérique du Nord", "franc français", "Martinique e.a.", "FRF" },
  { "HT", "Amérique du Nord", "gourde", "Haïti", "HTG" },
  { "CU", "Amérique du Nord", "peso cubain", "Cuba", "CUP" },
  { "DO", "Amérique du Nord", "peso dominicain", "Rép.  Dominicaine", "DOP" },
  { "MX", "Amérique du Nord", "peso mexicain", "Mexique", "MXP" },
  { "AR", "Amérique du Sud", "austral", "Argentine", "ARA" },
  { "VE", "Amérique du Sud", "bolivar", "Vénézuela", "VEB" },
  { "BR", "Amérique du Sud", "cruzeiro", "Brésil", "BRC" },
  { "GY", "Amérique du Sud", "dollar de Guyane", "Guyane", "GYD" },
  { "SR", "Amérique du Sud", "florin de Surinam", "Surinam", "SRG" },
  { "PY", "Amérique du Sud", "guarani", "Paraguay", "PYG" },
  { "AR", "Amérique du Sud", "peso argentin", "Argentine", "ARP" },
  { "BO", "Amérique du Sud", "peso bolivien", "Bolivie", "BOP" },
  { "CL", "Amérique du Sud", "peso chilien", "Chili", "CLP" },
  { "CO", "Amérique du Sud", "peso colombien", "Colombie", "COP" },
  { "UY", "Amérique du Sud", "peso uruguayen", "Uruguay", "UYP" },
  { "PE", "Amérique du Sud", "sol", "Pérou", "PES" },
  { "EC", "Amérique du Sud", "sucre", "Equateur", "ECS" },
  { "AF", "Asie", "afghani", "Afghanistan", "AFA" },
  { "TH", "Asie", "baht", "Thailande", "THB" },
  { "BH", "Asie", "dinar de Bahrein", "Bahrein", "BHD" },
  { "IQ", "Asie", "dinar irakien", "Irak", "IQD" },
  { "JO", "Asie", "dinar jordanien", "Jordanie", "JOD" },
  { "KW", "Asie", "dinar koweitien", "Koweit", "KWD" },
  { "AE", "Asie", "dirham des E A.U.", "Emirats Arabes Unis", "AED" },
  { "BN", "Asie", "dollar de Brunei", "Brunei", "BND" },
  { "HK", "Asie", "dollar de Hong Kong", "Hong Kong", "HKD" },
  { "SG", "Asie", "dollar de Singapour", "Singapour", "SGD" },
  { "TW", "Asie", "dollar taïwanien", "Taïwan", "TWD" },
  { "VN", "Asie", "dong", "Viêt-nam", "VND" },
  { "LA", "Asie", "kip", "Laos", "LAK" },
  { "CY", "Asie", "livre cypriote", "Chypre", "CYP" },
  { "LB", "Asie", "livre libanaise", "Liban", "LBP" },
  { "SY", "Asie", "livre syrienne", "Syrie", "SYP" },
  { "TR", "Asie", "livre turque", "Turquie", "TRL" },
  { "MO", "Asie", "pataca", "Macao", "MOP" },
  { "PH", "Asie", "peso philippin", "Philippines", "PHP" },
  { "QA", "Asie", "rial du Qatar", "Qatar", "QAR" },
  { "IR", "Asie", "rial iranien", "Iran", "IRR" },
  { "OM", "Asie", "rial omani", "Oman", "OMR" },
  { "KH", "Asie", "riel", "Cambodge", "KHR" },
  { "MY", "Asie", "ringgit", "Malaisie", "MYR" },
  { "YE", "Asie", "riyal du Yémen", "Yémen du Nord (Rép. arab.)", "YER" },
  { "SA", "Asie", "riyal saoudien", "Arabie Saoudite", "SAR" },
  { "RU", "Asie", "rouble de Russie", "Russie", "RUR" },
  { "LK", "Asie", "roupie de Sri Lanka", "Sri Lanka", "LKR" },
  { "NP", "Asie", "roupie du Népal", "Népal", "NPR" },
  { "PK", "Asie", "roupie du Pakistan", "Pakistan", "PKR" },
  { "BT", "Asie", "roupie indienne", "Buthan", "INR" },
  { "IN", "Asie", "roupie indienne", "Inde", "INR" },
  { "ID", "Asie", "rupiah", "Indonésie", "IDR" },
  { "IL", "Asie", "shékel", "Israël", "ILS" },
  { "BD", "Asie", "taka", "Bangladesh", "BDT" },
  { "MN", "Asie", "tugrik", "Mongolie", "MNT" },
  { "KR", "Asie", "won", "Corée du Sud", "KRW" },
  { "KP", "Asie", "won nord-coréen", "Corée du Nord", "KPW" },
  { "JP", "Asie", "yen", "Japon", "JPY" },
  { "CN", "Asie", "Yuan Ren-min-bi", "Chine", "CNY" },
  { "DK", "Europe", "couronne danoise", "Danemark", "DKK" },
  { "IS", "Europe", "couronne islandaise", "Islande", "ISK" },
  { "NO", "Europe", "couronne norvégienne", "Norvège", "NOK" },
  { "SK", "Europe", "couronne slovaque", "Slovaquie", "SKK" },
  { "SE", "Europe", "couronne suédoise", "Suède", "SEK" },
  { "CZ", "Europe", "couronne tchèque", "Tchéquie", "CZK" },
  { "DE", "Europe", "deutsche mark", "Allemagne", "DEM" },
  { "HR", "Europe", "dinar croate", "Croatie", "HRD" },
  { "GR", "Europe", "drachme", "Grèce", "GRD" },
  { "PT", "Europe", "escudo portugais", "Portugal (Açores-Madère)", "PTE" },
  { "NL", "Europe", "florin néerlandais", "Pays-Bas", "NLG" },
  { "HU", "Europe", "forint", "Hongrie", "HUF" },
  { "BE", "Europe", "franc belge", "Belgique", "BEF" },
  { "FR", "Europe", "franc français", "France", "FRF" },
  { "LU", "Europe", "franc luxembourgeois", "Luxembourg", "LUF" },
  { "LI", "Europe", "franc suisse", "Liechtenstein", "CHF" },
  { "CH", "Europe", "franc suisse", "Suisse", "CHF" },
  { "AL", "Europe", "lek", "Albanie", "ALL" },
  { "RO", "Europe", "leu", "Roumanie", "ROL" },
  { "BG", "Europe", "lev", "Bulgarie", "BGL" },
  { "IT", "Europe", "lire italienne", "Italie", "ITL" },
  { "SM", "Europe", "lire italienne", "San Marino", "ITL" },
  { "VA", "Europe", "lire italienne", "Vatican (St Siège)", "ITL" },
  { "GI", "Europe", "livre de Gibraltar", "Gibraltar", "GIP" },
  { "IE", "Europe", "livre irlandaise", "Irlande", "IEP" },
  { "MT", "Europe", "livre maltaise", "Malte", "MTP" },
  { "GB", "Europe", "livre sterling", "Royaume-Uni", "GBP" },
  { "FI", "Europe", "mark finlandais", "Finlande", "FIM" },
  { "SI", "Europe", "monnaie slovène", "Slovénie", "SIT" },
  { "YU", "Europe", "nouveau dinar yougoslave", "Yougoslavie", "YUD" },
  { "ES", "Europe", "peseta espagnole", "Espagne", "ESP" },
  { "AT", "Europe", "schilling autrichien", "Autriche", "ATS" },
  { "PL", "Europe", "zloty", "Pologne", "PLZ" },
  { "AU", "Océanie", "dollar australien", "Australie", "AUD" },
  { "KI", "Océanie", "dollar australien", "Kiribati", "AUD" },
  { "NR", "Océanie", "dollar australien", "Nauru", "AUD" },
  { "TV", "Océanie", "dollar australien", "Tuvalu", "AUD" },
  { "FJ", "Océanie", "dollar de Fidji", "Fidji", "FJD" },
  { "SB", "Océanie", "dollar de Salomon", "Iles Salomon", "SBD" },
  { "CK", "Océanie", "dollar néo-zélandais", "Cook Islands", "NZD" },
  { "NZ", "Océanie", "dollar néo-zélandais", "Nouvelle-Zélande", "NZD" },
  { "TP", "Océanie", "escudo de Timor", "Timor", "TPE" },
  { "WF", "Océanie", "franc CFP", "Iles Wallis &amp; Futuna", "XPF" },
  { "NC", "Océanie", "franc CFP", "Nouvelle-Calédonie", "XPF" },
  { "PF", "Océanie", "franc CFP", "Polynésie française", "XPF" },
  { "PG", "Océanie", "kina", "Papouasie - Nouvelle-Guinée", "PGK" },
  { "TO", "Océanie", "pa'anga", "Tonga", "TOP" },
  { "WS", "Océanie", "tala", "Samoa occidental", "WST" },
  { "VU", "Océanie", "vatu", "Vanuatu", "VUV" },
  { NULL },
};
