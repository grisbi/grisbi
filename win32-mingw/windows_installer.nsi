...
!define PLUGINS_DEV_PATH "${PROJECT_SOURCE_DIR}\target\Win32\plugins-dev" ;Path to the plugins-dev generated by prepare.cmd
!define OPENSSL_DIR "C:\OpenSSL-Win32"
...
;General
  ...
  ;Name and file
  Name "${FULLNAME}"
  !define MUI_ICON "${PACKAGE_DIR}\grisbi.ico"
  !define MUI_UNICON "${PACKAGE_DIR}\grisbi.ico"
...
Section $(OFXplug)
  ...
  File /r "${PACKAGE_DIR}\share\libofx\dtd"
  SetOutPath "$INSTDIR"
...
Section $(GnuCashPlugin)
  ...
  SetOutPath "$INSTDIR"
  File "${PACKAGE_DIR}\libxml2-2.dll"
  File "${PACKAGE_DIR}\iconv.dll"
